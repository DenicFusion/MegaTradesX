        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center">
          <div className="animate-fade-in max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button onClick={() => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' })} className="px-8 py-4 bg-secondary rounded-full text-white font-bold text-lg hover:bg-blue-600 transition-all hover:scale-105 shadow-lg shadow-blue-500/25">
                View Our Services
              </button>
            </div>
          </div>
      ...
      <div className="bg-dark-950 py-20 relative border-t border-white/5">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="glass-panel p-2 rounded-3xl relative aspect-video group cursor-pointer overflow-hidden">
            ...
            />
            {/* Note: Replace Image/Div with <iframe> when video link is available */}
          </div>
        </div>
      </div>
        ...
        <div className="glass-panel rounded-3xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="p-12 flex flex-col justify-center">
              ...
              <Link to="/register" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-dark-900 font-bold rounded-xl hover:bg-gray-200 transition-colors w-fit">
          ...
          <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
               <div className="order-2 md:order-1">
                  ...
                  <Link to="/register" className="text-secondary font-bold hover:underline flex items-center gap-1">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
               ...
               <div>
                  ...
                  <Link to="/register" className="px-8 py-3 bg-secondary rounded-full text-white font-bold hover:shadow-lg hover:shadow-blue-500/20 transition-all">
