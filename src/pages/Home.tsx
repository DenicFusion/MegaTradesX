...
import { 
  ...
  ExternalLink, BookOpen, Users, Video, TrendingUp, Shield, ArrowDownRight, ArrowUpRight
} from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  // COLLAGE IMAGES (Updated IBB Links)
  const collageImages = [
  ...
  // Tripling the array to create a smooth infinite scroll buffer
  ...
  useEffect(() => {
    ...
    const scroll = () => {
      if (scrollContainer && !isPaused) {
        ...
        // If scrolled past the second set, snap back to first set to loop
